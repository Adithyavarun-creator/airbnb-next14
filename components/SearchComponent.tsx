                        ...
                        step === 1 ?
                            <>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Please choose a country so that we can share house datas</DialogDescription>
                                </DialogHeader>
                            ...
                            : <>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Please share some informations</DialogDescription>
                                </DialogHeader>
                                    ...
                                    <CardHeader className="flex flex-col gap-y-5">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex flex-col">
                                                ...
                                                <p className="text-muted-foreground text-sm">
                                                    How many bathrooms do you have ?</p>
                                            </div>
